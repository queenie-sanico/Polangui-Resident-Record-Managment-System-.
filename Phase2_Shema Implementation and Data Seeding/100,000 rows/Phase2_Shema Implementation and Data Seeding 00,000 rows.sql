...
-- INSERT OFFICIAL BARANGAY NAMES
...
-- RESIDENT TABLE WITH HOUSEHOLD SIZE
...
-- RESIDENCY STATUS TABLE (remarks removed)
...
-- PROCEDURE TO GENERATE RANDOM RESIDENTS (remarks removed)
DELIMITER $$
...
BEGIN
    ...
    WHILE i <= num_residents DO
        ...
        -- INSERT RESIDENCY STATUS (NO remarks)
...
-- CALL TO GENERATE 100,000 RESIDENTS
CALL GenerateResidents(100000);

-- VIEW: RESIDENT DETAILED INFO
